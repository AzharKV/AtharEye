...
import { Avatar, Bar, Button, Card, SectionLabel, ScreenHeader } from '../components/primitives';
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: 2,
        flexShrink: 0,
        background: on ? T.accent : 'rgba(255,255,255,0.14)',
...
function Row({ icon, iconBg, title, value, toggle, onToggle, chevron, onClick, last }: RowProps) {
  return (
    <div
      onClick={
        onClick
    ...
    >
      ...
      {value !== undefined && (
        <span style={{ fontSize: 14.5, color: T.muted, marginRight: 2 }}>{value}</span>
      )}
      {toggle !== undefined && onToggle && <Toggle on={toggle} onChange={onToggle} />}
    ...
    <Screen>
      ...
      <div style={{ padding: '4px 20px 8px', display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <Card
          ...
          style={{ padding: 15, display: 'flex', alignItems: 'center', gap: 14 }}
        >
          ...
          <Card style={{ padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: 20, fontWeight: 800, color: T.accent }}>
                  {s.price}
                  <span style={{ fontSize: 13, color: T.muted, fontWeight: 600 }}>/{s.period}</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                background: 'rgba(20,184,192,0.1)',
                color: T.accent,
                fontSize: 14.5,
                fontWeight: 700,
                fontFamily: T.font,
          ...
          <Card style={{ padding: '18px 8px', display: 'flex' }}>
            {(
              ...
              >
                ...
                <div style={{ fontSize: 12.5, color: T.muted, marginTop: 3, fontWeight: 600 }}>
                  {l}
                </div>
              </div>
            ))}
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: 16,
                    background: on
                      ? 'linear-gradient(150deg, rgba(20,184,192,0.12), rgba(20,184,192,0.04))'
                      : T.surface,
                    border: `1.5px solid ${on ? T.accent : T.hairline}`,
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
                      <div style={{ fontSize: 22, fontWeight: 800, color: on ? T.accent : T.text }}>
                        {pl.price}
                      </div>
                        ...
                        <div key={f} style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                          <div
                            style={{
                              ...
                              height: 18,
                              borderRadius: 18,
                              background: 'rgba(20,184,192,0.16)',
                              display: 'flex',
                              alignItems: 'center',
                              justifyContent: 'center',
                              flexShrink: 0,
            ...
            {SUB_ADDONS.map((a, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  padding: '13px 0',
                  borderBottom: i < SUB_ADDONS.length - 1 ? `1px solid ${T.hairline2}` : 'none',
                }}
              >
