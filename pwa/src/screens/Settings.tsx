// Settings — units, date format, LiDAR quality, auto-align to BIM, notifications, about.
// Production-shaped (no demo/reset controls — a page refresh is the reset). Writes data.settings.
import { T } from '../theme';
