...
// Copied verbatim from pwa/src/data.ts — keep in sync with SPEC §10.
  ...
  projects: [
    {
      ...
      last: '2h ago',
      rooms: [
        { name: 'Shop Floor', pct: 88 },
        { name: 'Stock Room', pct: 62 },
        { name: 'Staff WC', pct: 96 },
        { name: 'Shopfront', pct: 70 },
        { name: 'Rear Lobby', pct: 54 },
      ],
      issues: [
    ...
    },
    {
      ...
      last: '1d ago',
      rooms: [
        { name: 'Kitchen Ext.', pct: 64 },
        { name: 'Utility', pct: 71 },
        { name: 'Roof Structure', pct: 40 },
        { name: 'Foundations', pct: 95 },
      ],
      issues: [
    ...
    },
    {
      ...
      last: '4h ago',
      rooms: [
        { name: 'Open Plan', pct: 94 },
        { name: 'Meeting Rms', pct: 88 },
        { name: 'Reception', pct: 97 },
        { name: 'Server Room', pct: 85 },
        { name: 'Kitchenette', pct: 90 },
      ],
      issues: [
    ...
    },
    {
      ...
      last: 'Yesterday',
      rooms: [
        { name: 'Main Floor', pct: 86 },
        { name: 'Mezzanine', pct: 74 },
        { name: 'Loading Bay', pct: 91 },
        { name: 'Office Block', pct: 62 },
      ],
      issues: [
    ...
    },
    {
      ...
      last: '3d ago',
      rooms: [
        { name: 'Living Room', pct: 48 },
        { name: 'Bathroom', pct: 30 },
        { name: 'Bedroom 1', pct: 52 },
        { name: 'Hallway', pct: 26 },
      ],
      issues: [
    ...
    },
    {
      ...
      rooms: [
        { name: 'Café Floor', pct: 100 },
        { name: 'Kitchen', pct: 100 },
        { name: 'Counter', pct: 100 },
        { name: 'WC', pct: 100 },
        { name: 'Store', pct: 100 },
      ],
      issues: [],
...
export const PLANS: Record<string, PlanRoom[]> = {
  p1: [
...
export function planFor(id: string): PlanRoom[] {
  return (
    PLANS[id] || [
...
export const BIM: Record<string, BimModel> = {
  p1: {
    file: 'ByresRoad_GF.ifc',
    size: '18.4 MB',
    ver: 'IFC4 · v3',
    uploaded: '28 May 2026',
    elements: '2,140',
  },
  p2: {
    file: 'Morningside_Ext.ifc',
    size: '9.1 MB',
    ver: 'IFC4 · v2',
  ...
  p5: {
    file: 'StirlingFlat.ifc',
    size: '6.8 MB',
    ver: 'IFC4 · v1',
    uploaded: '19 May 2026',
    elements: '640',
  },
  p6: {
    file: 'LeithCafe.ifc',
...
export function bimFor(id: string): BimModel {
  return BIM[id] || { file: 'model.ifc', size: '—', ver: 'IFC4', uploaded: '—', elements: '—' };
}
...
export const SUB_PLANS: SubPlan[] = [
  {
    ...
    price: '£0',
    period: '30 days',
    tagline: '1 project to try it out',
...
export const SUB_ADDONS: SubAddon[] = [
